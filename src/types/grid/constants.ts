...
export const GRID_CELL_TYPES: Record<GridCellKey, CellDefinition> = {
  ...
  Start: {
    ...
    front:   { code: "s", picture: "start.png" },
    back:    { code: "S", picture: "start_black.png" },
  },
  Goal: {
    label: "ゴール",
    color: "bg-blue-500",
    ...
    front:   { code: "g", picture: "goal.png" },
    back:    { code: "G", picture: "goal_black.png" },
  },
  DummyGoal: {
    label: "ダミーゴール",
    color: "bg-red-500",
    ...
    front:   { code: "d", picture: "dummy-goal.png" },
    back:    { code: "D", picture: "dummy-goal_black.png" },
  },
  Crow: {
    label: "カラス",
    color: "bg-black",
  ...
  Wolf: {
    ...
    front:   { code: "o", picture: "wolf.png" },
    back:    { code: "O", picture: "wolf_black.png" },
  },
  Trauma: {
    label: "トラウマ",
    color: "bg-purple-500",
  ...
  Rest: {
    ...
    front:   { code: "r", picture: "rest.png" },
    back:    { code: "R", picture: "rest_black.png" },
  },
  FootUp: {
    label: "足あと↑",
    color: "bg-gray-200",
  ...
  Flag: {
    ...
    front:   { code: "f", picture: "flag.png" },
    back:    { code: "F", picture: "flag_black.png" },
  },
  Switch: {
    label: "スイッチ",
    color: "bg-orange-400",
