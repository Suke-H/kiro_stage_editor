...
export const basicTests = () => {
  describe('基本機能', () => {
    it('基本的なパズル1を解く', () => {
      // URL: http://localhost:5173/stage?cells=h1w7gswbbbbg&panels=h1w4gbbbb&mode=play
    ...
    it('基本的なパズル2を解く', () => {
      // URL: http://localhost:5173/stage?cells=h5w5geeegeebbbwebbbwsbbbwewwwe&panels=h2w2gwbbw_h1w3gbwb&mode=play
